<?php
// PDO is a built-in class to php (i.e., creating instances of this class; like a blueprint for a house; $pdo is an instance of the PDO class)
?>
...
<?php
  ...
  if (isset($_GET['search'])) {
    $sql = $sql . ' WHERE customers.FirstName = ?';
  }
